...
import { sampleUserBoxData } from "@/components/common/user-box"
        ...
        <SheetContent side={'right'} className="overflow-y-auto">
        {
         activeChat?.groupInfo ? (
            <GroupChatContents
               ...
               members={activeChat.groupInfo.members}
            ...
            activeChat?.dmInfo ? (
               ...
               lastSeen={activeChat.dmInfo.lastSeen}
               bio={"I really loooooveeeee chatly!"}
