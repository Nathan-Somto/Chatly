...
function MessageOptions({
  ...
  return (
    <ContextMenu>
      <ContextMenuTrigger asChild disabled={messageOptions.disabled || disabled}>
        {children}
      </ContextMenuTrigger>
      <ContextMenuContent className="bg-gray-50  dark:bg-[#17191C] space-y-1  rounded-md z-[9999]  py-3 px-1.5 w-[225px]">
        <ContextMenuItem
          ...
          className="gap-2 py-2 px-4 justify-start hover:opacity-80"
        >
